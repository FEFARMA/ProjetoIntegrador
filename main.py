...
# pip install paho-mqtt flask -> conexao com os servidores

# CONEXAO COM O BANCO DE DADOS
# NOME DA APLICACAO
app = Flask("registro")

# a CONEXAO o SQLAlchemy para rastrear modificacoes
app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False

# Configurar a URI de conexao com o banco de  dados MySQL
...
def msg_sensor(client, userdata, msg):
    ...
    # Decodificar de tring para json
...
# Correlacao Banco de Dados com Sensores
    with app.app_context():
        try:
            ...
            co2 = mqtt.dados.get('co2')
            poeira = 0
            tempo_registro = mqtt.dados.get('timestamp')
...
# Criar o objeto que vai simular a tabela do banco
            ...
            # Adicionar um novo registro ao banco
